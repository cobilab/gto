...
\item \texttt{gto\char`_xs}: it is a skilled FASTQ read simulation tool, flexible, portable and tunable in terms of sequence complexity.
...
\input{\FASTQToolsPath/XS.tex}
%\input{\FASTQToolsPath/FastqClustReads.tex} %Has a bug
